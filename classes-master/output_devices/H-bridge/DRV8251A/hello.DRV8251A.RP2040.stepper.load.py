#
# hello.DRV8251A.RP2040.stepper.load.py
#    DRV8251A H-bridge stepper load measurement RP2040 hello-world
#
...
while True:
    ...
    print(f"micro step forward, PWM fraction 0.9, amps/phase: {amps(count/step_count):.2f}")
