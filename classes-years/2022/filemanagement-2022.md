# Asset file management report for 2022

- Generated: 2025-11-11T00:12:48+00:00
- Year snapshot base: `/classes-years/2022`
- Class root (canonical): `/classes-years/2022` ((entire year base))
- Canonical root: `/FabAcademyArchiveAssets/classes-master`
- Year-specific assets directory: `/FabAcademyArchiveAssets/classes-years/2022`
- Previous years considered: 2012 2013 2014 2015 2016 2017 2018 2019 2020 2021

## Summary

- Total files scanned: 3355
- Index files (index.html) always copied (no dedup): 77
- Identical files (vs canonical): 1389
- Different vs canonical (total): 1886
  - Variants first seen in 2022 (copied): 32
  - Variants shared with previous years (not copied): 1854
- Files missing in canonical (total): 3
  - First seen in 2022 (copied): 0
  - Shared with previous years (not copied): 3
- Total files copied into `classes-years/2022`: 109

Paths below are relative to `classes-years/2022`.
...
### 2.1 Variants first seen in 2022 (copied for this year)

- `embedded_programming/SWD/hello.CMSIS-DAP.10.D11C.kicad_sch`
- `embedded_programming/SWD/hello.CMSIS-DAP.10.D11C.kicad_pro`
- `embedded_programming/SWD/hello.CMSIS-DAP.10.D11C.kicad_prl`
- `embedded_programming/SWD/hello.CMSIS-DAP.10.D11C.brd`
- `embedded_programming/SWD/hello.CMSIS-DAP.10.D11C.kicad_pcb`
- `embedded_programming/SWD/hello.CMSIS-DAP.10.D11C.sch`
- `embedded_programming/D21E/boot/load`
- `embedded_programming/D21E/hello.D21E.echo`
- `embedded_programming/D11C/hello.D11C.echo.mini`
- `embedded_programming/D11C/hello.D11C.blink.make`
- `embedded_programming/D11C/hello.D11C.serial.micro.4`
- `embedded_programming/D11C/hello.D11C.echo.micro`
- `input_devices/tof/hello.VL53L0X.D11C`
- `input_devices/tof/hello.VL53L0X.D11C.ino`
- `input_devices/tof/hello.VL53L0X.D11C.py`
- `input_devices/step/hello.txrx.t1624.ino`
- `input_devices/step/hello.txrx.t1624.py`
- `output_devices/H-bridge/hello.H-bridge.D11C.ino`
- `output_devices/H-bridge/hello.H-bridge.D11C`
- `output_devices/servo/hello.servo-D11C`
- `output_devices/servo/hello.servo-registers.D11C.ino`
- `output_devices/servo/hello.servo-registers.t412.ino`
- `output_devices/speaker/hello.speaker-registers.D11C.ino`
- `output_devices/speaker/hello.speaker.D11C.ino`
- `output_devices/speaker/hello.speaker.D11C`
- `output_devices/stepper/hello.stepper.bipolar.D11C`
- `output_devices/stepper/hello.stepper.bipolar.D11C.ino`
- `project_management/archive.html`
- `project_management/scripts/Ubuntu_22.04`
- `project_management/scripts/Ubuntu_20.04`
- `project_management/scripts/Xubuntu_20.04`
...
### 3.1 First seen in 2022 (not in master or earlier years, copied)
