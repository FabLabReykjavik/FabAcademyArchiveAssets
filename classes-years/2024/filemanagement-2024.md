# Asset file management report for 2024

- Generated: 2025-11-11T00:20:39+00:00
- Year snapshot base: `/classes-years/2024`
- Class root (canonical): `/classes-years/2024` ((entire year base))
- Canonical root: `/FabAcademyArchiveAssets/classes-master`
- Year-specific assets directory: `/FabAcademyArchiveAssets/classes-years/2024`
- Previous years considered: 2012 2013 2014 2015 2016 2017 2018 2019 2020 2021 2022 2023

## Summary

- Total files scanned: 3726
- Index files (index.html) always copied (no dedup): 82
- Identical files (vs canonical): 1611
- Different vs canonical (total): 2031
  - Variants first seen in 2024 (copied): 55
  - Variants shared with previous years (not copied): 1976
- Files missing in canonical (total): 2
  - First seen in 2024 (copied): 0
  - Shared with previous years (not copied): 2
- Total files copied into `classes-years/2024`: 137

Paths below are relative to `classes-years/2024`.
...
- `system_integration/dis/index.html`
- `wildcard/index.html`
...
- `scanning_printing/FerretPro.jpg`
...
- `system_integration/dis/dis.png`
- `system_integration/dis/dis.jpg`
- `system_integration/Jan.pdf`
...
- `embedded_programming/debug/debug_Arduino_D11C14.mp4`
...
- `embedded_programming/sim/Wokwi.mp4`
- `embedded_programming/sim/AVR8js.mp4`
...
- `embedded_programming/t412/hello.t412.3.blink.mask.png`
...
- `input_devices/imu/6050/hello.MPU-6050.RP2040.mp4`
...
- `input_devices/mic/I2S/hello.ICS-43434.RP2040.interior.png`
- `input_devices/mic/I2S/hello.ICS-43434.RP2040.holes.png`
- `input_devices/mic/I2S/hello.ICS-43434.RP2040.jpg`
- `input_devices/mic/I2S/hello.ICS-43434.RP2040.top.png`
- `input_devices/mic/I2S/SPH0645LM4H-B.pdf`
- `input_devices/mic/I2S/hello.ICS-43434.RP2040.png`
- `input_devices/mic/I2S/DS-000069-ICS-43434-v1.2.pdf`
- `input_devices/mic/I2S/hello.ICS-43434.RP2040.mp4`
- `input_devices/mic/I2S/hello.ICS-43434.RP2040.speaker.jpg`
...
- `input_devices/step/steptime/hello.steptime.RP2040.holes.png`
- `input_devices/step/steptime/hello.steptime.RP2040.mp4`
- `input_devices/step/steptime/CVDT.mp4`
- `input_devices/step/steptime/CVDT.jpg`
- `input_devices/step/steptime/hello.steptime.RP2040.png`
- `input_devices/step/steptime/hello.steptime.comparator.RP2040.png`
- `input_devices/step/steptime/hello.steptime.RP2040.top.png`
- `input_devices/step/steptime/hello.steptime.RP2040.interior.png`
- `input_devices/step/steptime/hello.steptime.comparator.RP2040.jpg`
- `input_devices/step/steptime/hello.steptime.comparator.RP2040.top.png`
- `input_devices/step/steptime/hello.steptime.comparator.RP2040.interior.png`
- `input_devices/step/steptime/hello.steptime.RP2040.jpg`
- `input_devices/step/steptime/hello.steptime.comparator.RP2040.holes.png`
- `input_devices/step/hello.txrx.45.traces_exterior.png`
- `input_devices/step/hello.txrx.45.png`
- `input_devices/step/D21/hello.touch.D21.png`
- `input_devices/step/D21/pinout.jpg`
- `input_devices/step/D21/hello.touch.D21.mp4`
- `input_devices/step/D21/bottom.jpg`
- `input_devices/step/D21/hello.touch.D21.top.png`
- `input_devices/step/D21/hello.touch.D21.jpg`
- `input_devices/step/D21/hello.touch.D21.interior.png`
...
- `input_devices/step/sim/step.mp4`
- `input_devices/step/caliper.jpg`
- `input_devices/step/hello.txrx2.RP2040.mp4`
- `input_devices/step/hello.txrx.45.jpg`
- `input_devices/step/hello.txrx.45.traces.png`
- `input_devices/step/ESP32S3/hello.touch.S3.mp4`
- `input_devices/step/ESP32S3/S3.jpg`
- `input_devices/step/ESP32S3/hello.touch.S3.interior.png`
- `input_devices/step/ESP32S3/hello.touch.S3.jpg`
- `input_devices/step/ESP32S3/hello.touch.S3.top.png`
- `input_devices/step/ESP32S3/hello.touch.S3.png`
...
- `input_devices/step/t412/hello.load.RP2040.t412.jpg`
- `input_devices/step/t412/hello.load.RP2040.t412.mp4`
- `input_devices/step/t412/hello.load.RP2040.t412.holes.png`
- `input_devices/step/t412/hello.load.RP2040.t412.top.png`
- `input_devices/step/t412/hello.load.RP2040.t412.png`
- `input_devices/step/t412/hello.load.RP2040.t412.interior.png`
- `input_devices/step/RC/hello.load.RC.holes.png`
- `input_devices/step/RC/sn74lvc1g14.pdf`
- `input_devices/step/RC/hello.load.RC.png`
- `input_devices/step/RC/hello.load.RC.interior.png`
- `input_devices/step/RC/hello.load.RC.top.png`
- `input_devices/step/hello.txrx.t1624.jpg`
- `input_devices/step/hello.txrx2.RP2040.jpg`
- `input_devices/step/RP2040/hello.txrx.RP2040.op-amp.interior.png`
- `input_devices/step/RP2040/hello.steptime1.RP2040.png`
- `input_devices/step/RP2040/hello.load.RP2040.ring.top.png`
- `input_devices/step/RP2040/tlv365.pdf`
- `input_devices/step/RP2040/hello.steptime1.RP2040.top.png`
- `input_devices/step/RP2040/hello.steptime1.RP2040.jpg`
- `input_devices/step/RP2040/hello.load.RP2040.ring.png`
- `input_devices/step/RP2040/hello.txrx.RP2040.op-amp.holes.png`
- `input_devices/step/RP2040/hello.steptime1.RP2040.interior.png`
- `input_devices/step/RP2040/hello.txrx.RP2040.op-amp.jpg`
- `input_devices/step/RP2040/hello.load.RP2040.ring.interior.png`
- `input_devices/step/RP2040/hello.txrx.RP2040.op-amp.png`
- `input_devices/step/RP2040/hello.steptime1.RP2040.mp4`
- `input_devices/step/RP2040/hello.txrx.RP2040.op-amp.top.png`
- `input_devices/step/RP2040/hello.txrx.RP2040.op-amp.mp4`
...
- `input_devices/step/ring/hello.load.RP2040.ring.top.png`
- `input_devices/step/ring/sn74lvc3g14.pdf`
- `input_devices/step/ring/hello.load.RP2040.ring.png`
- `input_devices/step/ring/hello.load.RP2040.ring.holes.png`
- `input_devices/step/ring/hello.load.RP2040.ring.interior.png`
...
- `output_devices/Neo/hello.WS2812B.RP2040.jpg`
- `output_devices/Neo/hello.WS2812B.interior.png`
- `output_devices/Neo/hello.WS2812B.png`
- `output_devices/Neo/hello.WS2812B.RP2040.mp4`
- `output_devices/Neo/hello.WS2812B.top.png`
- `output_devices/Neo/WS2812B.pdf`
- `output_devices/Neo/ws2812.py`
- `output_devices/Neo/SK6812.pdf`
...
- `output_devices/H-bridge/DRV8251A/hello.DRV8251A.RP2040.jpg`
- `output_devices/H-bridge/DRV8251A/hello.DRV8251A.RP2040.png`
- `output_devices/H-bridge/DRV8251A/hello.DRV8251A.RP2040.PD.top.png`
- `output_devices/H-bridge/DRV8251A/hello.DRV8251A.RP2040.stepper.mp4`
- `output_devices/H-bridge/DRV8251A/hello.DRV8251A.RP2040.stepper.PD.mp4`
- `output_devices/H-bridge/DRV8251A/hello.DRV8251A.RP2040.PD.interior.png`
- `output_devices/H-bridge/DRV8251A/hello.DRV8251A.RP2040.top.png`
- `output_devices/H-bridge/DRV8251A/hello.DRV8251A.RP2040.PD.jpg`
- `output_devices/H-bridge/DRV8251A/hello.DRV8251A.RP2040.PD.holes.png`
- `output_devices/H-bridge/DRV8251A/hello.DRV8251A.RP2040.stepper.load.mp4`
- `output_devices/H-bridge/DRV8251A/hello.DRV8251A.RP2040.interior.png`
- `output_devices/H-bridge/DRV8251A/hello.DRV8251A.RP2040.PD.png`
...
- `output_devices/I2S/hello.MAX98357A.RP2040.top.png`
- `output_devices/I2S/MAX98357A-MAX98357B.pdf`
- `output_devices/I2S/hello.MAX98357A.RP2040.jpg`
- `output_devices/I2S/hello.MAX98357A.RP2040.interior.png`
- `output_devices/I2S/hello.MAX98357A.RP2040.fix.jpg`
- `output_devices/I2S/hello.MAX98357A.RP2040.holes.png`
- `output_devices/I2S/hello.MAX98357A.RP2040.I2S.png`
- `output_devices/I2S/hello.MAX98357A.RP2040.png`
- `output_devices/I2S/hello.MAX98357A.RP2040.mp4`
...
- `output_devices/BLDC/hello.A4949.RP2040.top.png`
- `output_devices/BLDC/hello.A4949.RP2040.jpg`
- `output_devices/BLDC/A4945-A4949-Datasheet.pdf`
- `output_devices/BLDC/hello.A4949.RP2040.mp4`
- `output_devices/BLDC/hello.A4949.RP2040.png`
- `output_devices/BLDC/hello.A4949.RP2040.interior.png`
...
- `networking_communications/ATP/hello.ATP.RP2040.interior.png`
- `networking_communications/ATP/hello.ATP.RP2040.jpg`
- `networking_communications/ATP/hello.ATP.RP2040.top.png`
- `networking_communications/ATP/hello.ATP.RP2040.timing.png`
- `networking_communications/ATP/hello.ATP.RP2040.png`
- `networking_communications/ATP/hello.ATP.RP2040.mp4`
...
- `networking_communications/APA/APA.RP2040.jpg`
...
- `electronics_production/PCBs.jpg`
...
- `electronics_production/pads.jpg`
- `electronics_production/V.jpg`
- `electronics_production/stencil.jpg`
...
### 2.1 Variants first seen in 2024 (copied for this year)

- `system_integration/dis/oldindex.html`
- `input_devices/tof/hello.VL53L1X.py`
- `input_devices/imu/hello.4754.RP2040.py`
- `input_devices/imu/6050/hello.MPU-6050.RP2040`
- `input_devices/imu/6050/hello.MPU-6050.ino`
- `input_devices/imu/6050/hello.MPU-6050.py`
- `input_devices/mic/I2S/hello.ICS-43434.RP2040`
- `input_devices/mic/I2S/hello.ICS-43434.RP2040.py`
- `input_devices/mic/I2S/hello.ICS-43434.RP2040.ino`
- `input_devices/step/steptime/hello.steptime.RP2040`
- `input_devices/step/steptime/hello.steptime.RP2040.plot.py`
- `input_devices/step/steptime/hello.steptime.RP2040.py`
- `input_devices/step/steptime/hello.steptime.comparator.RP2040`
- `input_devices/step/D21/hello.touch.D21`
- `input_devices/step/D21/hello.touch.D21.ino`
- `input_devices/step/sim/step.txt`
- `input_devices/step/ESP32S3/hello.touch.S3`
- `input_devices/step/ESP32S3/hello.touch.S3.py`
- `input_devices/step/ESP32S3/hello.touch.S3.ino`
- `input_devices/step/t412/hello.load.RP2040.py`
- `input_devices/step/t412/hello.load.t412.ino`
- `input_devices/step/t412/hello.load.RP2040.t412`
- `input_devices/step/RC/hello.load.RC`
- `input_devices/step/RP2040/hello.steptime1.RP2040.py`
- `input_devices/step/RP2040/hello.txrx.RP2040.op-amp`
- `input_devices/step/RP2040/hello.load.RP2040.ring`
- `input_devices/step/RP2040/hello.steptime1.RP2040`
- `input_devices/step/RP2040/hello.txrx.RP2040.op-amp.ino`
- `input_devices/step/RP2040/hello.steptime1.RP2040.plot.py`
- `input_devices/step/ring/hello.load.RP2040.ring`
- `output_devices/Neo/hello.WS2812B.RP2040.py`
- `output_devices/Neo/hello.WS2812B`
- `output_devices/H-bridge/DRV8251A/hello.DRV8251A.RP2040.stepper.load.py`
- `output_devices/H-bridge/DRV8251A/hello.DRV8251A.RP2040`
- `output_devices/H-bridge/DRV8251A/hello.DRV8251A.RP2040.stepper.PD.py`
- `output_devices/H-bridge/DRV8251A/hello.DRV8251A.RP2040.stepper.py`
- `output_devices/H-bridge/DRV8251A/hello.DRV8251A.RP2040.PD`
- `output_devices/I2S/hello.MAX98357A.RP2040.sample.ino`
- `output_devices/I2S/hello.h`
- `output_devices/I2S/hello.MAX98357A.RP2040.DMA.py`
- `output_devices/I2S/hello.MAX98357A.RP2040`
- `output_devices/I2S/hello.MAX98357A.RP2040.py`
- `output_devices/I2S/hello.MAX98357A.RP2040.2.ino`
- `output_devices/I2S/hello.MAX98357A.RP2040.ino`
- `output_devices/BLDC/hello.A4949.RP2040`
- `output_devices/BLDC/hello.A4949.RP2040.py`
- `computer_design/video.html`
- `project_management/scripts/Ubuntu_24.04`
- `networking_communications/ATP/hello.ATP.RP2040.send.py`
- `networking_communications/ATP/hello.ATP.RP2040`
- `networking_communications/ATP/ATP.txt`
- `networking_communications/ATP/hello.ATP.RP2040.recv.py`
- `networking_communications/hop/hello.hop-LED.t1624.ino`
- `networking_communications/hop/hello.hop-LED.py`
- `networking_communications/APA/APA.txt`
...
- `embedded_programming/ESP32-C3/hello.button-blink.C3.py` → shared with year `2023`
- `embedded_programming/ESP32-C3/hello.button-blink.C3` → shared with year `2023`
- `embedded_programming/ESP32-C3/hello.button-blink.C3.ino` → shared with year `2023`
...
- `embedded_programming/RP2040/hello.button-blink.RP2040.2.py` → shared with year `2023`
- `embedded_programming/RP2040/hello.button-blink.RP2040.2.ino` → shared with year `2023`
- `embedded_programming/RP2040/hello.button-blink.RP2040` → shared with year `2023`
- `embedded_programming/RP2040/hello.button-blink.RP2040.1.py` → shared with year `2023`
- `embedded_programming/RP2040/hello.button-blink.RP2040.1.ino` → shared with year `2023`
- `embedded_programming/hello.echo.ino` → shared with year `2023`
...
- `embedded_programming/hello.echo.py` → shared with year `2023`
...
- `input_devices/imu/hello.4754.RP2040.html` → shared with year `2023`
- `input_devices/imu/hello.4754.RP2040` → shared with year `2023`
- `input_devices/imu/hello.4754.C3.ino` → shared with year `2023`
- `input_devices/imu/three.min.js` → shared with year `2023`
- `input_devices/imu/hello.4754.RP2040.ino` → shared with year `2023`
...
- `input_devices/image/hello.ESP32-Sense.ino` → shared with year `2023`
...
- `input_devices/step/hello.txrx2.RP2040` → shared with year `2023`
...
- `input_devices/step/hello.txrx2.RP2040.ino` → shared with year `2023`
...
- `output_devices/H-bridge/hello.TB67H451.RP2040.sample.ino` → shared with year `2023`
- `output_devices/H-bridge/hello.TB67H451.RP2040` → shared with year `2023`
- `output_devices/H-bridge/convert.py` → shared with year `2023`
- `output_devices/H-bridge/hello.TB67H451.RP2040.sample.py` → shared with year `2023`
- `output_devices/H-bridge/hello.TB67H451.RP2040.wave.py` → shared with year `2023`
...
- `output_devices/H-bridge/hello.TB67H451.RP2040.wave.ino` → shared with year `2023`
...
- `output_devices/H-bridge/hello.TB67H451.RP2040.ino` → shared with year `2023`
- `output_devices/H-bridge/hello.H-bridge.44.Zetex.c` → shared with year `2015`
- `output_devices/H-bridge/hello.TB67H451.RP2040.audio.ino` → shared with year `2023`
- `output_devices/H-bridge/hello.TB67H451.RP2040.sample.main.ino` → shared with year `2023`
- `output_devices/H-bridge/hello.TB67H451.RP2040.py` → shared with year `2023`
- `output_devices/H-bridge/convert_byterray.py` → shared with year `2023`
- `output_devices/H-bridge/boot.py` → shared with year `2023`
- `output_devices/H-bridge/hello.TB67H451.RP2040.audio.py` → shared with year `2023`
- `output_devices/H-bridge/hello.H-bridge.D11C` → shared with year `2022`
- `output_devices/H-bridge/hello.py` → shared with year `2023`
...
- `output_devices/RGB/hello.RP2040-XIAO.blink-echo.ino` → shared with year `2023`
...
- `output_devices/RGB/hello.RP2040-XIAO.blink-echo.py` → shared with year `2023`
...
- `output_devices/OLED/ssd1306.py` → shared with year `2023`
- `output_devices/OLED/hello.SSD1306.RP2040.py` → shared with year `2023`
...
- `output_devices/OLED/hello.SSD1306.RP2040` → shared with year `2023`
...
- `output_devices/fade/hello.fade.C3.py` → shared with year `2023`
...
- `project_management/archive.html` → shared with year `2023`
- `project_management/scripts/Ubuntu_22.04` → shared with year `2023`
...
- `interface_application_programming/remote.html` → shared with year `2023`
- `interface_application_programming/xor.txt` → shared with year `2023`
- `interface_application_programming/xor.py` → shared with year `2023`
- `interface_application_programming/canvas_lines.html` → shared with year `2012`
- `interface_application_programming/programs/taichipi.py` → shared with year `2023`
...
- `interface_application_programming/programs/lines.py` → shared with year `2023`
...
- `interface_application_programming/programs/taichisurf.py` → shared with year `2023`
...
- `interface_application_programming/programs/pygfxsurf.py` → shared with year `2023`
- `interface_application_programming/programs/surface.py` → shared with year `2023`
...
- `interface_application_programming/programs/images.py` → shared with year `2023`
...
- `interface_application_programming/WebSockets/microdot_websocket.py` → shared with year `2023`
- `interface_application_programming/WebSockets/hello.ws-blink.js.html` → shared with year `2023`
- `interface_application_programming/WebSockets/TCP/hello.TCP-serial-blink.C3.py` → shared with year `2023`
- `interface_application_programming/WebSockets/TCP/tcpclient.py` → shared with year `2023`
- `interface_application_programming/WebSockets/TCP/tcpserver.py` → shared with year `2023`
- `interface_application_programming/WebSockets/TCP/hello.TCP-blink.C3.py` → shared with year `2023`
- `interface_application_programming/WebSockets/microdot_asyncio_websocket.py` → shared with year `2023`
- `interface_application_programming/WebSockets/hello.ws-blink.C3.py` → shared with year `2023`
- `interface_application_programming/WebSockets/hello.ws-blink.js` → shared with year `2023`
- `interface_application_programming/WebSockets/hello.ws-blink.Node-RED.json` → shared with year `2023`
- `interface_application_programming/WebSockets/microdot_asyncio.py` → shared with year `2023`
- `interface_application_programming/WebSockets/node_modules/.package-lock.json` → shared with year `2023`
- `interface_application_programming/WebSockets/node_modules/ws/README.md` → shared with year `2023`
- `interface_application_programming/WebSockets/node_modules/ws/wrapper.mjs` → shared with year `2023`
- `interface_application_programming/WebSockets/node_modules/ws/lib/validation.js` → shared with year `2023`
- `interface_application_programming/WebSockets/node_modules/ws/lib/receiver.js` → shared with year `2023`
- `interface_application_programming/WebSockets/node_modules/ws/lib/subprotocol.js` → shared with year `2023`
- `interface_application_programming/WebSockets/node_modules/ws/lib/constants.js` → shared with year `2023`
- `interface_application_programming/WebSockets/node_modules/ws/lib/buffer-util.js` → shared with year `2023`
- `interface_application_programming/WebSockets/node_modules/ws/lib/event-target.js` → shared with year `2023`
- `interface_application_programming/WebSockets/node_modules/ws/lib/websocket.js` → shared with year `2023`
- `interface_application_programming/WebSockets/node_modules/ws/lib/stream.js` → shared with year `2023`
- `interface_application_programming/WebSockets/node_modules/ws/lib/limiter.js` → shared with year `2023`
- `interface_application_programming/WebSockets/node_modules/ws/lib/sender.js` → shared with year `2023`
- `interface_application_programming/WebSockets/node_modules/ws/lib/websocket-server.js` → shared with year `2023`
- `interface_application_programming/WebSockets/node_modules/ws/lib/permessage-deflate.js` → shared with year `2023`
- `interface_application_programming/WebSockets/node_modules/ws/lib/extension.js` → shared with year `2023`
- `interface_application_programming/WebSockets/node_modules/ws/LICENSE` → shared with year `2023`
- `interface_application_programming/WebSockets/node_modules/ws/index.js` → shared with year `2023`
- `interface_application_programming/WebSockets/node_modules/ws/package.json` → shared with year `2023`
- `interface_application_programming/WebSockets/node_modules/ws/browser.js` → shared with year `2023`
- `interface_application_programming/WebSockets/microdot.py` → shared with year `2023`
- `interface_application_programming/WebSockets/hello.ws-blink.mjs` → shared with year `2023`
...
- `interface_application_programming/MQTT/hello.MQTT-blink.C3.py` → shared with year `2023`
- `interface_application_programming/MQTT/hello.MQTT-blink.C3.html` → shared with year `2023`
- `interface_application_programming/MQTT/mqtt.min.js` → shared with year `2023`
...
- `networking_communications/hop/hello.hop-LED.t1624` → shared with year `2023`
- `networking_communications/hop/hello.broadhop-LED.py` → shared with year `2023`
- `networking_communications/hop/hello.broadhop-serial.D11C` → shared with year `2023`
- `networking_communications/hop/hello.broadhop-LED.t1624.ino` → shared with year `2023`
- `networking_communications/hop/hello.broadhop-LED.t1624` → shared with year `2023`
...
- `networking_communications/ESP32C3/blueart.py` → shared with year `2023`
- `networking_communications/ESP32C3/hello.Web-blink.C3.py` → shared with year `2023`
- `networking_communications/ESP32C3/hello.BLE-blink.C3.py` → shared with year `2023`
- `networking_communications/ESP32C3/microdot_asyncio.py` → shared with year `2023`
- `networking_communications/ESP32C3/microdot.py` → shared with year `2023`
- `networking_communications/ESP32C3/hello.BLE-blink.C3.html` → shared with year `2023`
...
- `networking_communications/SD/sdcard.py` → shared with year `2023`
- `networking_communications/SD/hello.uSD.RP2040` → shared with year `2023`
- `networking_communications/SD/hello.uSD.D11C` → shared with year `2019`
- `networking_communications/SD/hello.uSD.RP2040.py` → shared with year `2023`
...
### 3.1 First seen in 2024 (not in master or earlier years, copied)
