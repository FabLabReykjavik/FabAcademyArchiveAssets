# Asset file management report for 2020

- Generated: 2025-11-10T22:43:15+00:00
- Year snapshot base: `/classes-years/2020`
- Class root (canonical): `/classes-years/2020` ((entire year base))
- Canonical root: `/FabAcademyArchiveAssets/classes-master`
- Year-specific assets directory: `/FabAcademyArchiveAssets/classes-years/2020`
- Previous years considered: 2012 2013 2014 2015 2016 2017 2018 2019

## Summary

- Total files scanned: 2989
- Index files (index.html) always copied (no dedup): 75
- Identical files (vs canonical): 952
- Different vs canonical (total): 1954
  - Variants first seen in 2020 (copied): 142
  - Variants shared with previous years (not copied): 1812
- Files missing in canonical (total): 8
  - First seen in 2020 (copied): 0
  - Shared with previous years (not copied): 8
- Total files copied into `classes-years/2020`: 217

Paths below are relative to `classes-years/2020`.
...
### 2.1 Variants first seen in 2020 (copied for this year)

- `electronics_design/KiCad.mp4`
- `embedded_programming/rx.py`
...
- `embedded_programming/D21E/boot/openocd.cfg`
- `embedded_programming/D21E/hello.D21E.echo`
- `embedded_programming/term.py`
- `embedded_programming/t3216/hello.t3216.echo`
- `embedded_programming/t3216/hello.t3216.echo.traces.png`
- `embedded_programming/t3216/hello.t3216.echo.interior.png`
- `embedded_programming/t3216/hello.t3216.echo.ino`
...
- `embedded_programming/hello.ftdi.44.echo.interrupt.c`
- `embedded_programming/D11C/hello.D11C.serial.3V3`
- `embedded_programming/D11C/hello.D11C.blink.reset.interior.png`
- `embedded_programming/D11C/hello.D11C.serial.5V`
...
- `embedded_programming/D11C/hello.D11C.blink.reset.clock`
- `embedded_programming/D11C/hello.D11C.blink.pullup`
- `embedded_programming/D11C/hello.D11C.blink.reset`
- `embedded_programming/D11C/hello.D11C.blink.reset.traces.png`
- `input_devices/tof/hello.VL53L1X.t1614.interior.png`
- `input_devices/tof/hello.VL53L1X.t1614`
- `input_devices/tof/hello.VL53L1X.ino`
- `input_devices/tof/hello.VL53L1X.py`
- `input_devices/tof/hello.VL53L1X.t1614.traces.png`
- `input_devices/radar/hello.RCWL-0516.py`
- `input_devices/temp/hello.temp.45.py`
- `input_devices/color/hello.VEML6040.py`
- `input_devices/color/hello.VEML6040.ino`
- `input_devices/color/hello.VEML6040.t412`
...
- `input_devices/button/hello.button.D11C.ino`
- `input_devices/button/hello.button.t412`
- `input_devices/button/hello.button.D11C.traces.png`
- `input_devices/button/hello.button.USB.ino`
- `input_devices/button/hello.button.D11C`
- `input_devices/button/hello.button.t412.ino`
- `input_devices/button/hello.button.D11C.interior.png`
- `input_devices/button/hello.button.serial.ino`
- `input_devices/python/rx.py`
- `input_devices/python/term.py`
- `input_devices/mic/hello.SPU0414HR5H.py`
- `input_devices/mic/hello.CMM-4030D-261-I2S-TR.py`
- `input_devices/mic/hello.CMM-4030D-261-I2S-TR.t1614.traces.png`
- `input_devices/mic/hello.mic.45.py`
- `input_devices/mic/hello.CMM-4030D-261-I2S-TR.t1614.interior.png`
- `input_devices/mic/hello.CMM-4030D-261-I2S-TR.t1614`
- `input_devices/mic/hello.CMM-4030D-261-I2S-TR.ino`
- `input_devices/accelgyro/hello.LSM6DS33.ino`
- `input_devices/accelgyro/hello.LSM6DS33.t1614`
- `input_devices/accelgyro/hello.LSM6DS33.t1614.traces.png`
- `input_devices/accelgyro/hello.LSM6DS33.py`
- `input_devices/accelgyro/hello.LSM6DS33.t1614.interior.png`
- `input_devices/step/hello.load.45.py`
- `input_devices/step/hello.txrx.45.py`
- `input_devices/sonar/hello.HC-SR04.py`
- `input_devices/motion/hello.HC-SR501.py`
- `input_devices/light/hello.light.45.py`
- `input_devices/light/hello.reflect.45.py`
- `input_devices/accel/hello.MXD6235MP.py`
- `input_devices/accel/hello.ADXL343.py`
- `input_devices/mag/hello.mag.t412.interior.png`
- `input_devices/mag/hello.mag.D11C.ino`
- `input_devices/mag/hello.mag.USB.ino`
- `input_devices/mag/hello.mag.45.py`
- `input_devices/mag/hello.mag.t412.ino`
- `input_devices/mag/hello.mag.t412.traces.png`
- `input_devices/mag/hello.mag.D11C`
- `input_devices/mag/hello.mag.D11C.traces.png`
- `input_devices/mag/hello.mag.D11C.interior.png`
- `input_devices/mag/hello.mag.serial.ino`
- `input_devices/mag/hello.mag.t412`
- `output_devices/LEDs/hello.LEDs.t412.traces.png`
- `output_devices/LEDs/hello.LEDs.t412.interior.png`
- `output_devices/LEDs/hello.LEDs.t412.ino`
- `output_devices/LEDs/hello.LEDs.t412`
- `output_devices/OLED/pixbyte8.py`
- `output_devices/TFT/hello.ILI9341.HW.D21E.top.png`
- `output_devices/TFT/hello.ILI9341.HW.D21E`
- `output_devices/TFT/hello.ILI9341.SW.D21E`
...
- `output_devices/array/hello.array.44`
- `output_devices/array/hello.array.44.2`
- `output_devices/stepper/hello.stepper.44`
- `output_devices/stepper/hello.stepper.bipolar.44`
...
- `project_management/scripts/Xubuntu_18.04`
- `project_management/scripts/Xubuntu_20.04`
- `interface_application_programming/remote.html`
- `interface_application_programming/programs/numbapi.py`
- `interface_application_programming/programs/udprcv.py`
- `interface_application_programming/programs/mpipi2.py`
- `interface_application_programming/programs/lines.py`
- `interface_application_programming/programs/pi.py`
- `interface_application_programming/programs/plotly-latest.min.js`
- `interface_application_programming/programs/sympi.py`
...
- `networking_communications/MFRC522/hello.MFRC522.t1614`
- `networking_communications/APA/apa.py`
- `networking_communications/ESP8266/hello.ESP-01`
- `networking_communications/ESP8266/hello.ESP-01.echo.ino`
...
- `networking_communications/ESP8266/hello.ESP-WROOM-02D`
- `networking_communications/ESP8266/hello.ESP-01.traces.png`
- `networking_communications/ESP8266/hello.ESP-WROOM-02D.echo.ino`
- `networking_communications/ESP32/hello.ESP32-WROOM.echo.ino`
- `networking_communications/ESP32/hello.ESP32-CAM.ino`
- `networking_communications/SLIP/udp_slip.py`
- `networking_communications/i0/thtpv4.py`
- `old/embedded_networking_communications/thtpv4.py`
...
- `embedded_programming/D11C/hello.D11C.blink.make` → shared with year `2019`
...
- `computer_design/image.html` → shared with year `2019`
...
### 3.1 First seen in 2020 (not in master or earlier years, copied)

_None._

### 3.2 Shared with previous years (not copied for this year)

- `embedded_programming/UPDI/FTDI-UPDI.jpg` → shared with year `2019`
- `embedded_programming/UPDI/FTDI-UPDI.traces.png` → shared with year `2019`
- `embedded_programming/UPDI/FTDI-UPDI.png` → shared with year `2019`
- `embedded_programming/UPDI/FTDI-UPDI.interior.png` → shared with year `2019`
- `embedded_programming/UPDI/FTDI-UPDI` → shared with year `2019`
