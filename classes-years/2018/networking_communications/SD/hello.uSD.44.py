...
pcb = wire(pcb,w,
   J2.pad[1],
   point(IC1.pad[14].x,J2.pad[1].y,z),
   IC1.pad[14])

pcb = wire(pcb,w,
   IC1.pad[11],
   point(IC1.pad[11].x+.1,IC1.pad[11].y,z),
   point(IC1.pad[11].x+.13,J2.pad[4].y,z),
   J2.pad[4])

pcb = wire(pcb,w,
   IC1.pad[10],
   point(IC1.pad[10].x+.07,IC1.pad[10].y,z),
   point(IC1.pad[10].x+.12,J2.pad[5].y,z),
   J2.pad[5])

R1 = R_1206('R1\n10k');
pcb = R1.add(pcb,IC1.x,IC1.pad[1].y+.1,z)
...
pcb = wire(pcb,w,
   IC1.pad[13],
   point(R1.pad[2].x,IC1.pad[13].y,z),
   R1.pad[2])

pcb = wire(pcb,w,
   R1.pad[2],
   point(R1.pad[2].x,R1.y+.06,z),
   point(IC1.pad[1].x,R1.y+.06,z),
   IC1.pad[1])

IC2 = regulator_SOT23('IC2\n3.3V')
pcb = IC2.add(pcb,J2.x-.16,J2.pad[2].y,z,angle=90)

pcb = wire(pcb,w,
   J2.pad[3],
   point(IC2.pad[2].x,J2.pad[3].y,z),
   IC2.pad[2])

pcb = wire(pcb,w,
   J2.pad[1],
   point(IC2.pad[3].x,J2.pad[1].y,z),
   IC2.pad[3])

pcb = wire(pcb,w,
   J1.pad[2],
   point(J1.pad[2].x,J1.pad[2].y-.08,z),
   point(J2.x+.08,J1.pad[2].y-.08,z),
   point(J2.x+.08,J2.pad[4].y+.05,z),
   point(IC2.pad[1].x,J2.pad[4].y+.05,z),
   IC2.pad[1])
...
pcb = wire(pcb,w,
   C1.pad[1],
   point(C1.pad[1].x,IC2.pad[1].y,z),
   IC2.pad[1])

pcb = wire(pcb,w,
   J2.pad[1],
   point(C1.pad[2].x,J2.pad[1].y,z),
   C1.pad[2])

pcb = wire(pcb,w,
   IC1.pad[13],
   point(C1.pad[1].x,IC1.pad[13].y,z),
   C1.pad[1])

J3 = microSD('J3\nmicroSD')
pcb = J3.add(pcb,IC1.x-.42,IC1.y-.1,z,angle=-90)

pcb = wire(pcb,w,
   J3.pad[2],
   point(J3.pad[2].x+.07,J3.pad[2].y,z),
   point(J3.pad[2].x+.07,J3.y-.315,z),
   point(IC1.pad[6].x-.08,J3.y-.315,z),
   point(IC1.pad[6].x-.08,IC1.pad[6].y,z),
   IC1.pad[6])

pcb = wire(pcb,w,
   J3.pad[3],
   point(J3.pad[3].x+.105,J3.pad[3].y,z),
   point(J3.pad[3].x+.105,J3.y-.28,z),
   point(IC1.pad[5].x-.115,J3.y-.28,z),
   point(IC1.pad[5].x-.115,IC1.pad[5].y,z),
   IC1.pad[5])

pcb = wire(pcb,w,
   J1.pad[2],
   point(J1.pad[2].x,J1.pad[2].y-.08,z),
   point(J1.pad[6].x+.05,J1.pad[2].y-.08,z),
   point(J1.pad[6].x+.05,J1.y-.02,z),
   point(IC1.pad[7].x+.01,J1.y-.02,z),
   point(IC1.pad[7].x+.01,J1.pad[6].y,z),
   point(J3.pad[4].x-.07,J1.pad[6].y,z),
   point(J3.pad[4].x-.07,J3.pad[4].y,z),
   J3.pad[4])

pcb = wire(pcb,w,
   J3.pad[5],
   point(J3.pad[5].x+.105,J3.pad[5].y,z),
   point(J3.pad[5].x+.105,J3.y+.28,z),
   point(IC1.pad[3].x-.115,J3.y+.28,z),
   point(IC1.pad[3].x-.115,IC1.pad[3].y,z),
   IC1.pad[3])

pcb = wire(pcb,w,
   J1.pad[6],
   point(J1.pad[6].x,J1.pad[6].y-.08,z),
   point(J3.pad[6].x-.105,J1.pad[6].y-.08,z),
   point(J3.pad[6].x-.105,J3.pad[6].y,z),
   J3.pad[6])

pcb = wire(pcb,w,
   IC1.pad[14],
   point(IC1.pad[14].x,R1.y+.095,z),
   point(J3.pad[6].x-.105,R1.y+.095,z),
   point(J3.pad[6].x-.105,J3.pad[6].y,z),
   J3.pad[6])

pcb = wire(pcb,w,
   J3.pad[7],
   point(J3.pad[7].x+.07,J3.pad[7].y,z),
   point(J3.pad[7].x+.07,J3.y+.315,z),
   point(IC1.pad[2].x-.08,J3.y+.315,z),
