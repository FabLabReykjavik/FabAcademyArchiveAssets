...
pcb = IC1.add(pcb,x+.54,y+.31,z,angle=90)
...
pcb = wire(pcb,w,
   IC1.pad[8],
   point(R1.pad[1].x,IC1.pad[8].y,z),
   R1.pad[1])

IC2 = regulator_SOT23('IC2\n5V')
pcb = IC2.add(pcb,R1.x-.155,R1.y-.02,z)
...
pcb = wire(pcb,w,
   ...
   point(R1.pad[1].x,C1.y+.07,z),
   R1.pad[1])

J1 = header_ISP('J1\nISP')
pcb = J1.add(pcb,IC1.x+.31,IC1.y+.02,z,angle=180)

pcb = wire(pcb,w,
   J1.pad[1],
   point(J1.pad[1].x,J1.pad[1].y-.05,z),
   point(IC1.pad[6].x,J1.pad[1].y-.05,z),
   IC1.pad[6])

pcb = wire(pcb,w,
   J1.pad[2],
   point(J1.pad[4].x+.08,J1.pad[2].y,z),
   point(J1.pad[4].x+.08,J1.pad[4].y-.05,z),
   point(IC1.pad[8].x,J1.pad[4].y-.05,z),
   IC1.pad[8])

pcb = wire(pcb,w,
   J1.pad[3],
   point(IC1.pad[7].x,J1.pad[3].y,z),
   IC1.pad[7])

pcb = wire(pcb,w,
   IC1.pad[5],
   point(IC1.pad[5].x,IC1.pad[5].y+.035,z),
   point(J1.x,IC1.pad[5].y+.035,z),
   point(J1.x,J1.y,z),
   J1.pad[4])
...
pcb = wire(pcb,w,
   ...
   point(J1.pad[5].x,IC1.pad[1].y+.07,z),
   J1.pad[5])

pcb = wire(pcb,w,
   IC1.pad[1],
   point(IC1.pad[1].x,IC1.pad[1].y+.07,z),
   point(R1.pad[2].x,IC1.pad[1].y+.07,z),
   R1.pad[2])

pcb = wire(pcb,w,
   IC1.pad[4],
   point(J1.pad[6].x,IC1.pad[4].y,z),
   J1.pad[6])

J2 = header_power('J2\npower')
pcb = J2.add(pcb,IC2.x+.0,IC2.y-.20,z)

pcb = wire(pcb,w,
   J2.pad[1],
   point(IC1.pad[4].x,J2.pad[1].y,z),
   IC1.pad[4])

pcb = wire(pcb,w-.001,
   IC2.pad[3],
   point(IC2.pad[3].x,J2.pad[3].y+.05,z),
   point(J2.pad[1].x+.09,J2.pad[3].y+.05,z),
   point(J2.pad[1].x+.09,J2.pad[1].y,z),
   J2.pad[1])

pcb = wire(pcb,w,
   IC2.pad[2],
   point(J2.pad[4].x-.08,IC2.pad[2].y,z),
   point(J2.pad[4].x-.08,J2.pad[4].y,z),
   J2.pad[4])
...
J3 = header_4('J3\nspeaker')
pcb = J3.add(pcb,J2.x+.03,C1.y+.19,z,angle=180)
...
pcb = wire(pcb,w,
   J3.pad[4],
   point(J2.pad[4].x-.08,J3.pad[4].y,z),
   point(J2.pad[4].x-.08,J2.pad[4].y,z),
   J2.pad[4])

T1 = NMOSFET_SOT23('T1\nN')
pcb = T1.add(pcb,IC1.pad[7].x,J3.pad[1].y+.0125,z,angle=0)

pcb = wire(pcb,w,
   T1.pad[1],
   point(IC1.pad[6].x,T1.pad[1].y,z),
   IC1.pad[6])

pcb = wire(pcb,w-.001,
   T1.pad[2],
   point(J3.pad[2].x-.08,T1.pad[2].y,z),
   point(J3.pad[2].x-.08,IC2.y,z),
   IC2.pad[3])

pcb = wire(pcb,w,
   T1.pad[3],
   point(J3.pad[1].x,T1.pad[3].y,z),
   J3.pad[1])
