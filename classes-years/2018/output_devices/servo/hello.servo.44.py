...
# hello.servo.44.py
#
# servo motor hello-world, ZLDO1117 regulator version
...
pcb = wire(pcb,w,
   IC1.pad[1],
   point(J1.x-.05,IC1.pad[1].y,z),
   point(J1.x-.05,J1.y+.033,z),
   point(J1.pad[2].x,J1.y+.033,z),
   J1.pad[2])
...
pcb = wire(pcb,w,
   IC1.pad[7],
   point(IC1.pad[7].x,J1.y+.05,z),
   point(J1.pad[5].x-.025,J1.y,z),
   point(J1.pad[4].x,J1.y,z),
   J1.pad[4])
...
pcb = XTAL1.add(pcb,IC1.pad[2].x-.19,IC1.pad[2].y,z,angle=-90)

pcb = wire(pcb,w,
   IC1.pad[2],
   point(XTAL1.x+.11,IC1.pad[2].y,z),
   point(XTAL1.x+.11,XTAL1.pad[1].y,z),
   XTAL1.pad[1])

pcb = wire(pcb,w,
   IC1.pad[3],
   point(XTAL1.pad[3].x,IC1.pad[3].y,z),
   XTAL1.pad[3])

R1 = R_1206('R1\n10k')
pcb = R1.add(pcb,XTAL1.x-.14,XTAL1.y,z,angle=-90)

pcb = wire(pcb,w,
   R1.pad[1],
   point(R1.pad[1].x,R1.pad[1].y+.04,z),
   point(IC1.pad[1].x,R1.pad[1].y+.04,z),
   IC1.pad[1])

pcb = wire(pcb,w,
   IC1.pad[4],
   point(R1.pad[2].x,IC1.pad[4].y,z),
   R1.pad[2])

J2 = header_power('J2\npower')
pcb = J2.add(pcb,x+.18,y+height-.14,z)

pcb = wire(pcb,w,
   XTAL1.pad[2],
   point(R1.x-.085,XTAL1.pad[2].y,z),
   point(R1.x-.085,J2.pad[1].y,z),
   J2.pad[1])

IC2 = regulator_SOT223('IC2\n5V')
pcb = IC2.add(pcb,J2.x+.37,J2.y-.07,z,angle=180)

pcb = wire(pcb,w,
   IC2.pad[1],
   point(IC1.pad[14].x,IC2.pad[1].y,z),
   IC1.pad[14])

pcb = wire(pcb,w,
   IC2.pad[1],
   point(IC2.pad[1].x,IC2.pad[1].y+.06,z),
   point(J2.x,IC2.pad[1].y+.06,z),
   point(J2.x,J2.pad[1].y,z),
   J2.pad[1])
...
pcb = wire(pcb,w,
   IC2.pad[4],
   point(IC1.pad[1].x,IC2.pad[4].y,z),
   IC1.pad[1])

C1 = C_1206('C1\n10uF')
pcb = C1.add(pcb,J2.x,J2.y-.14,z,angle=0)

pcb = wire(pcb,w,
   J2.pad[2],
   point(C1.pad[1].x,J2.pad[2].y,z),
   C1.pad[1])

pcb = wire(pcb,w,
   C1.pad[2],
   point(IC1.pad[1].x,C1.y,z),
   IC1.pad[1])

J3 = header_servo('J3\nservo')
pcb = J3.add(pcb,J2.x+.03,J1.y+.05,z)

pcb = wire(pcb,w,
   J1.pad[6],
   point(J3.pad[1].x,J1.pad[6].y,z),
   J3.pad[1])
...
pcb = wire(pcb,w,
   ...
   point(J1.pad[4].x-.05,J1.pad[2].y-.08,z),
   point(J1.pad[4].x-.05,J1.y-.033,z),
   point(IC1.pad[7].x,J1.y-.033,z),
   point(J3.pad[3].x+.05,J3.pad[3].y,z),
   J3.pad[3])
...
pcb = wire(pcb,w,
   IC1.pad[6],
   point(J3.pad[6].x,IC1.pad[6].y,z),
   J3.pad[6])

pcb = wire(pcb,w,
   IC1.pad[7],
   point(J3.pad[5].x,IC1.pad[7].y,z),
   J3.pad[5])
