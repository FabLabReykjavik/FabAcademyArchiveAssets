...
# hello.servo.44.1.py
#
# servo motor hello-world, LM2940 regulator version
...
J2 = header_power('J2\npower')
pcb = J2.add(pcb,x+.18,y+height-.1,z)
...
IC2 = regulator_SOT223_1('IC2\n5V')
pcb = IC2.add(pcb,J2.x+.37,J2.y-.04,z,angle=-90)
...
pcb = wire(pcb,w,
   IC2.pad[3],
   point(IC1.pad[1].x,IC2.pad[3].y,z),
   IC1.pad[1])

pcb = wire(pcb,w,
   IC2.pad[4],
   point(IC1.pad[14].x,IC2.pad[4].y,z),
   IC1.pad[14])
...
pcb = wire(pcb,w,
   IC2.pad[3],
   point(C1.pad[2].x,IC2.pad[3].y,z),
   C1.pad[2])
