...
# hello.ftdi.16E5.py
#
# XMEGA 16E5 FTDI echo hello-world
#    usage: pcb.py | frep.py [dpi [filename]]
#
# Neil Gershenfeld 10/27/15
...
IC1 = ATxmegaE5_TQFP('IC1\n16E5')
pcb = IC1.add(pcb,x+.66,y+.3,z)

pcb = wire(pcb,w,
   IC1.pad[17],
   point(IC1.pad[32].x+.1,IC1.pad[17].y,z),
   point(IC1.pad[32].x,IC1.pad[17].y+.1,z),
   IC1.pad[32])

J1 = header_PDI('J1\nPDI')
pcb = J1.add(pcb,IC1.pad[1].x-.26,IC1.y+.02,z,angle=0)
...
pcb = wire(pcb,w,
   J1.pad[6],
   point(J1.pad[6].x-.08,J1.pad[6].y,z),
   point(J1.pad[6].x-.08,IC1.pad[9].y-.04,z),
   point(J1.pad[6].x-.03,IC1.pad[9].y-.09,z),
   point(IC1.pad[18].x+.05,IC1.pad[9].y-.09,z),
   point(IC1.pad[18].x+.05,IC1.pad[18].y,z),
   IC1.pad[18])
...
pcb = wire(pcb,w,
   IC1.pad[21],
   point(IC1.pad[21].x+.08,IC1.pad[21].y,z),
   point(IC1.pad[21].x+.08,J2.pad[5].y,z),
   J2.pad[5])

pcb = wire(pcb,w,
   IC1.pad[22],
   point(IC1.pad[22].x+.11,IC1.pad[22].y,z),
   point(IC1.pad[22].x+.11,J2.pad[4].y,z),
   J2.pad[4])

IC2 = regulator_SOT23('IC2\n3.3V')
pcb = IC2.add(pcb,J2.pad[1].x-.17,J2.pad[1].y+.05,z,angle=90)

pcb = wire(pcb,w,
   J2.pad[3],
   point(J2.pad[3].x,J2.pad[3].y+.05,z),
   point(IC2.pad[2].x+.04,J2.pad[3].y+.05,z),
   point(IC2.pad[2].x,J2.pad[3].y+.09,z),
   IC2.pad[2])

pcb = wire(pcb,w,
   IC2.pad[3],
   point(J2.pad[1].x-.04,IC2.pad[3].y,z),
   point(J2.pad[1].x,IC2.pad[3].y-.04,z),
   J2.pad[1])

C1 = C_1206('C1\n1uF');
pcb = C1.add(pcb,IC2.x-.12,IC2.y+.03,z,angle=90)
...
pcb = wire(pcb,w,
   C1.pad[2],
   point(IC2.pad[3].x,C1.pad[2].y,z),
   IC2.pad[3])

C2 = C_1206('C2\n0.1uF');
pcb = C2.add(pcb,IC1.pad[32].x,C1.y,z,angle=90)
...
pcb = wire(pcb,w,
   C2.pad[2],
   point(J1.pad[6].x-.03,C2.pad[2].y,z),
   point(J1.pad[6].x-.08,C2.pad[2].y-.05,z),
   point(J1.pad[6].x-.08,J1.pad[6].y,z))
...
pcb = wire(pcb,w,
   C2.pad[2],
   point(IC1.pad[1].x,C2.pad[2].y,z),
   IC1.pad[1])

R1 = R_1206('R1\n10k')
pcb = R1.add(pcb,J1.x,J1.y-.2,z)

pcb = wire(pcb,w,
   R1.pad[1],
   point(R1.pad[1].x,IC1.pad[9].y-.06,z),
   point(IC1.pad[17].x,IC1.pad[9].y-.06,z),
   IC1.pad[17])
...
pcb = wire(pcb,w,
   R1.pad[2],
   point(IC1.pad[8].x,R1.y,z),
   IC1.pad[8])

pcb = wire(pcb,w,
   R1.pad[2],
   point(J1.x,R1.y,z),
   point(J1.x,J1.pad[5].y,z),
   J1.pad[5])

R2 = R_1206('R2\n1k')
pcb = R2.add(pcb,J1.x,J1.y+.2,z)

LED1 = LED_1206('LED1')
pcb = LED1.add(pcb,R2.x,R2.y+.1,z,angle=180)

pcb = wire(pcb,w,
   LED1.pad[1],
   point(IC1.pad[2].x-.06,LED1.y,z),
   point(IC1.pad[2].x-.06,IC1.pad[2].y,z),
   IC1.pad[2])
...
pcb = wire(pcb,w,
   R2.pad[1],
   point(J1.pad[6].x-.08,R2.pad[1].y,z))
