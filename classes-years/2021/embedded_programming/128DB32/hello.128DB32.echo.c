//
// hello.128DB32.echo.c
//
// 128DB32 echo hello-world
...
#define serial_pin_out PIN0_bm
#define serial_pin_in PIN1_bm
...
int main(void) {
   ...
   static int index;
   //
   // unprotect clock and select 24 MHz
   //
   CPU_CCP = CCP_IOREG_gc;
   CLKCTRL.OSCHFCTRLA = 9 << 2;
   //
   // initialize pins
   //
   ...
   while (1) {
      ...
      put_string(&serial_port_out,serial_pin_out,"hello.128DB32.echo.c: you typed \"");
      buffer[index++] = chr;
